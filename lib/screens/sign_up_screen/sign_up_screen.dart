...
class _SignUpScreenState extends State<SignUpScreen> {
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                        hintText: "Enter preferred display name "),
                  ),
                  Container(
                    height: 20,
                  ),
                  Consumer<SignUpProvider>(builder: (_, data, __) {
                    return !data.loadingCountries
                        ? Column(
                            children: [
                              DropdownButton<String>(
                                ...
                                onChanged: (String? newValue) {
                                  ...
                                  setState(() => countryCode = data.countries!
                                      .firstWhere((element) =>
                                          element.countryModelId == newValue)
                                      .countryCode);
                                  context
                                      .read<SignUpProvider>()
                                      .fetchStates(context, newValue);
                                },
                              ),
                              Visibility(
                          ...
                          onTap: () {
                            if (_formKey.currentState!.validate()) {
                              ...
                              validateEmail(email.text.toString(),
                                  username.text.toString(), context);
                            }
                          },
                          child: Container(
                  ...
                  TextFormField(
                    ...
                    validator: (String? value) {
                      if (value == null || value.isEmpty) {
                        showMessageError("Please enter a password");
                        ...
                        ? GestureDetector(
                            onTap: () {
                              ...
                              if (_formKey2.currentState!.validate()) {
                                ...
                                context
                                    .read<SignUpProvider>()
                                    .signUpUser(userModel.toJson2(), context);
                              }
                            },
                            child: Container(
                                margin:
  ...
  void validateEmail(email, username, context) {
    setState(() => validatingMail = true);
    auth.validateMail(email, username).then((value) {
      setState(() => validatingMail = false);
      nextPage();
    }).catchError((onError) {
      setState(() => validatingMail = false);
