  ...
  Widget chip(String item, int i){
    return Container(
        decoration: BoxDecoration(
            border: Border.all(color:  (i==currentCategoryItemIndex) ? Colors.orange : DefaultSelectionStyle.defaultColor),
        ...
        child:  Row(
          children: [
            FaIcon(icons[i], size: 15, color: (i==currentCategoryItemIndex) ? Colors.orange: null),
            Container(width: 10,),
            Text(item, style: TextStyle(fontSize: 13, color: (i==currentCategoryItemIndex) ? Colors.orange: null,),)
          ],
        ));
  }
