...
import 'package:campus_mart/Screens/AdScreen/success_screen.dart';
            ...
            child: ListView(
              ...
              children: [
                ...
                Visibility(
                  ...
                  child: SizedBox(child:DropdownButton<PaymentTypeModel>(
                    value: selectPayment,
                ...
                Visibility(
                    ...
                    child:TextFormField(
                      ...
                      controller: price,
                      onChanged: (e){
                        setState(()=> productModel.price = !productModel.contactForPrice! ? int.parse(e.toString().replaceAll("N","")):0);
                      },
                ...
                Visibility(
                  visible: _images.isEmpty && widget.product.images!.isNotEmpty,
                  child: SizedBox(
                      height: 100,
                      width: 50,
                      child: GridView.count(
                        ...
                        children: widget.product.images!.map((image) {
                          return Image.network(image['url'], fit:BoxFit.contain);
                        }).toList(),
                      )),
                ),
